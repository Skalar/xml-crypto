  ...
  for (var n in this.references) {
    ...
    for (var h in nodes) {
      ...
      for (var t in ref.transforms) {
        ...
        console.log(ref.inclusiveNamespacesPrefixList)
        if (ref.inclusiveNamespacesPrefixList) {
          console.log('Adding inclusiveNamespacesPrefixList')
          res += "<" + prefix + "Transform Algorithm=\"" + transform.getAlgorithmName() + "\">"
          res += "<InclusiveNamespaces xmlns=\"" + transform.getAlgorithmName() + "\" PrefixList=\"" + ref.inclusiveNamespacesPrefixList + "\"/>"
        } else {
          res += "<" + prefix + "Transform Algorithm=\"" + transform.getAlgorithmName() + "\" />"
        }
      }

      var canonXml = this.getCanonXml(ref.transforms, node, { inclusiveNamespacesPrefixList: ref.inclusiveNamespacesPrefixList })
